...
$mail->Body    = 'Your Activation Code is '.$hash.' Please Click On This link <a href="http://localhost:8080/travelguides/verification_update.php">'.$hash.'</a>to activate your account.';
